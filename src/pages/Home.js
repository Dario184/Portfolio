            ...
            <div className='bg-zinc-900'>
                ...
                <form class="w-full max-w-lg ml-auto mr-auto px-8 pb-12 ">
                    <div class="flex flex-wrap -mx-3 mb-6">
                        ...
                        <label class="block uppercase tracking-wide text-gray-200 text-xs text-left font-bold mb-2" for="grid-last-name">
                            Cognome
                        </label>
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        ...
                        <label class="block uppercase tracking-wide text-gray-200 text-xs text-left font-bold mb-2" for="grid-password">
                            E-mail
                        </label>
